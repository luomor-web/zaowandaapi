...
mkdir -p ../eladmin-web/src/views/question/exam
cp -r docker/lillia/question/exam/index.vue ../eladmin-web/src/views/question/exam
cp -r docker/lillia/question/exam/questionTodayAnswer.js ../eladmin-web/src/api
